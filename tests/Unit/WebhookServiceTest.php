...
class WebhookServiceTest extends TestCase
{
    ...
    public function canCreateSubscriptionSuccessfully(): void
    {
        ...
        $mockApi = $this->createMock(\Square\Api\WebhookSubscriptionsApi::class);
        ...
        $mockResult->method('getResult->getSubscription')->willReturn($mockSubscription);
        ...
        $this->mockSubscriptionDao->expects($this->once())
            ...
            ->with([
                'square_id' => 'sub_123456',
                'url' => $url,
                'events' => json_encode($events),
                'signature_key' => 'test_signature_key',
                'is_active' => true,
                $this->isType('string'), // created_at
            ])
            ->willReturn(1);
    ...
    public function canListSubscriptionsSuccessfully(): void
    {
        ...
        $mockResult = $this->createMock(\Square\ApiResponse::class);
        $mockResult->method('isSuccess')->willReturn(true);
        $mockResult->method('getResult->getSubscriptions')
            ->willReturn([$mockSubscription1, $mockSubscription2]);
    ...
    public function handleWebhookEventSucceedsWithValidSignature(): void
    {
        ...
        $this->mockSubscriptionDao->expects($this->once())
            ...
            ->with([
                ...
                $this->isType('string'), // processed_at
            ])
            ->willReturn(1);
